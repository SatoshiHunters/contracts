...
contract SATOSHIPrivateSale {
    ...
    uint256 public totalTokensToSell = 30000000 * 10**18;          // 30000000 SATOSHI tokens for sell
    uint256 public satoshiPerBnb = 10000 * 10**18;             // 1 BNB = 10000 SATOSHI
