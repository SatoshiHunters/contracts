...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.satoshi = await MockBEP20.deployed();
        ...
        await this.satoshi.transfer(bob, '2000', { from: minter });
        await this.satoshi.transfer(alice, '2000', { from: minter });
        await this.satoshi.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.satoshi.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.satoshi.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.satoshi.balanceOf(this.lotteryProxyAddress)).toString(), '418');
